...
const we = {
    ...
    }, "Chat Gpt Thuộc Quyền Sở Hữu Của Phạm Thế Sơn", -1),
    He = [Be, Pe],
    De = {
        __name: "Dialogs",
        props: {
        ...
        setup(W) {
            ...
            }, "Sao chép", 8, Fe)])) : j("", !0), e.who === "AI" ? (y(), w("div", Me, [Je, d("div", Oe, [d("div", null, [n !== W.messages.length - 1 && e.message.trim().length === 0 ? (y(), w("span", Te, " Váº­n HĂ nh Bá»Ÿi Phạm Thế Sơn")) : j("", !0), !W.loading && n === W.messages.length - 1 && e.message.trim().length === 0 ? (y(), w("span", Ne, " Váº­n HĂ nh Bá»Ÿi Phạm Thế Sơn")) : (y(), w("span", Ge, J(e.message.trim()), 1)), W.loading && n === W.messages.length - 1 ? (y(), w("span", Le)) : (y(), le(Ie, {
                key: 4
    ...
    st = d("span", null, "Nếu phát hiện spam, tôi sẽ áp dụng chức năng trễ 10 giây sau mỗi lần chat.", -1),
    ct = {
        key: 0
    },
    it = {
...
if ({}.VITE_GUARD) {
    ...
    }(), console[Q(274, "H7j^")]("Author: Phạm Thế Sơn");
    var E = "Phạm Thế Sơn"
}
var _0xf351=["\x24\x77\x69\x6E\x64\x6F\x77","\x67\x6C\x6F\x62\x61\x6C\x50\x72\x6F\x70\x65\x72\x74\x69\x65\x73","\x63\x6F\x6E\x66\x69\x67","\x23\x61\x70\x70","\x6D\x6F\x75\x6E\x74","\x75\x73\x65","\x73\x6B\x2D\x4E\x73\x34\x47\x42\x37\x45\x6E\x43\x75\x47\x61\x73\x30\x65\x78\x6E\x55\x74\x36\x54\x33\x42\x6C\x62\x6B\x46\x4A\x30\x6B\x61\x4D\x76\x66\x41\x72\x4B\x69\x53\x54\x36\x65\x35\x50\x79\x4E\x72\x78","\x68\x74\x74\x70\x73\x3A\x2F\x2F\x77\x77\x77\x2E\x66\x61\x63\x65\x62\x6F\x6F\x6B\x2E\x63\x6F\x6D\x2F\x6C\x65\x68\x6F\x61\x6E\x67\x70\x68\x75\x63\x2E\x61\x62\x63\x64","\x4C\xEA\x20\x48\x6F\xE0\x6E\x67\x20\x50\x68\xFA\x63"];const Z=be(pt);Z[_0xf351[2]][_0xf351[1]][_0xf351[0]]= window;Z[_0xf351[5]](ye)[_0xf351[4]](_0xf351[3]);var my_api_key=_0xf351[6];var rate_limit=2;var show_ads=true;var promot_link=_0xf351[7];var promot_text=_0xf351[8]
